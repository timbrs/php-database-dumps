 ...
 *  G-5 — родитель с sample выгружается раньше (сейчас работает, но держится на порядке имён);
            ...
            foreach ($entries as $entry) {
                ...
                $findings[] = Finding::note(
                    ...
                    sprintf(
                        ...
                        . 'связность держится на SelectedPkRegistry и на алфавитном порядке имён',
                        $parentKey
                    ),
                    $childSchema,
                    $childTable,
