...
class OpencodeRunner
{
    ...
    private const WRITE_DIRECTIVE = 'ОБЯЗАТЕЛЬНО создай выходной файл инструментом write как '
        . 'валидный JSON по контракту database/analysis/output_schema.json. Если файл уже '
        . 'существует — СНАЧАЛА ознакомься с его текущим содержимым через read (учти уже собранное: '
        . 'сохрани корректное, дополни/исправь), и только потом перезапиши write. opencode запрещает '
